...
tellraw @a [{text:"Simple ingame Team Creator",color:"blue"},{text:" by Edward821821",color:"green",click_event:{action:"open_url",url:"https://modrinth.com/user/Edward821821"}},{text:" loaded!",color:"white"}]
